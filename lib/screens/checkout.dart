  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        elevation: 5,
        leading: IconButton(icon:Icon(Icons.arrow_back_ios),color:Colors.brown,onPressed:() {},
        iconSize:20,
        ),
        title:Container(
          width: MediaQuery.of(context).size.width/1.6,
          child: Text("Edit Profile",style: TextStyle(color:Colors.brown,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)),
